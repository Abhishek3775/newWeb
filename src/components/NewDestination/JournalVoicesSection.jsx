...
const articles = [
  {
    ...
    desc: "Our travel editor spent ten days at an unnamed atoll in the Maldives - accessible only by arrangement. Here is the unedited account.",
    date: "FEBRUARY 2026",
    readTime: "8 min read",
  },
  {
    ...
    desc: "A singular arrangement with one of Kyoto’s oldest Buddhist orders grants Aurum clients access to temple ceremonies closed to the public since 1923.",
    date: "JANUARY 2026",
    readTime: "6 min read",
  },
  {
